...
class Utils:
    ...
    def get_acc(self, grb_model, local_data, b, beta, p):
        '''
        ...
        for i in local_data.index:
            yhat_i = self.get_predicted_value(
                grb_model, local_data, b, beta, p, i)
    ...
    def get_mae(self, grb_model, local_data, b, beta, p):
        '''
    ...
    def get_mse(self, grb_model, local_data, b, beta, p):
        '''
    ...
    def get_r_squared(self, grb_model, local_data, b, beta, p):
        '''
